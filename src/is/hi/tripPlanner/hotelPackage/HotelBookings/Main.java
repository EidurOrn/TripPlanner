...
import is.hi.tripPlanner.hotelPackage.JFrames.AdalFrame;
...
public class Main {
    ...
    public static void setUpDatabase() {
        ...
        SQLiteJDBC.insertIntoHotelRooms(17, "Hotel KEA","2017-04-05","2017-10-12",45792 , "double", "Family", 4, "Nordurland");
        SQLiteJDBC.insertIntoHotelRooms(18, "Hotel KEA","2017-04-05","2017-07-29",36700 , "single", "Family", 4, "Nordurland");
        SQLiteJDBC.insertIntoHotelRooms(19, "Hotel Mývatn","2017-02-06","2017-12-10",26700, "double", "Family", 3, "Nordurland");
        SQLiteJDBC.insertIntoHotelRooms(20, "Hotel Mývatn","2017-04-06","2017-12-01",19200 , "single", "Family", 3, "Nordurland");
        SQLiteJDBC.insertIntoHotelRooms(21, "Hotel Kjarnalundur","2017-02-06","2017-12-31",39000, "double", "Family", 2, "Nordurland");
        SQLiteJDBC.insertIntoHotelRooms(22,"Hotel Icelandair Akureyri","2017-02-06","2017-12-31",47000, "double", "Family", 3, "Nordurland");
        SQLiteJDBC.insertIntoHotelRooms(23, "Hotel Eskifjördur","2017-01-01","2017-12-31",22000 , "double", "Family", 2, "Austurland");
        SQLiteJDBC.insertIntoHotelRooms(24, "Hotel Selfoss","2017-04-04","2017-08-21",18126 , "double", "Family", 4, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(25, "Hotel Selfoss","2017-04-04","2017-08-21",50085 , "suite", "Family", 4, "Sudurland");
        ...
        SQLiteJDBC.insertIntoHotelRooms(31, "Hotel Icelandair Akureyri","2017-02-06","2017-10-31",47000, "double", "Buisness", 3, "Nordurland");
        ...
        SQLiteJDBC.insertIntoHotelRooms(36, "Hotel Selfoss","2017-04-04","2017-08-21",18126 , "double", "Romantic", 4, "Sudurland");
        ...
        SQLiteJDBC.insertIntoHotelRooms(39, "Hotel Eldhestar","2017-08-02","2017-11-21",16933 , "double", "Family", 2, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(40, "Hotel Grimsborgir","2017-02-02","2017-09-01",47223 , "double", "Family", 4, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(41, "Hotel Grimsborgir","2017-01-02","2017-07-08",76138 , "suite", "Family", 4, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(42, "Hotel Grimsborgir","2017-02-02","2017-09-18",32456 , "single", "Family", 4, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(43, "Hotel Edda Vík","2017-01-02","2017-11-09",26253 , "double", "Family", 3, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(44, "Hotel Edda Vík","2017-03-22","2017-10-09",21803 , "single", "Family", 3, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(45, "Hotel Edda Vík","2017-10-22","2017-12-31",36253 , "double", "Family", 3, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(46, "Puffin Hotel Vík","2017-04-08","2017-11-21",17053 , "double", "Family", 3, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(47, "Puffin Hotel Vík","2017-08-02","2017-11-21" ,33731, "triple", "Family", 3, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(48, "Sólbakki","2017-03-02","2017-08-21" ,103507, "Villa", "Family", 3, "Vesturland");
        SQLiteJDBC.insertIntoHotelRooms(49, "Tower Suites Reykjavík","2017-08-02","2017-11-21" ,198507, "suite", "Romantic", 5, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(50, "Tower Suites Reykjavík","2017-08-02","2017-11-21" ,198507, "suite", "Buisness", 5, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(51, "Hólar Private Luxury Villa","2017-04-02","2017-11-21" , 481426, "Villa", "Buisness", 5, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(52, "Hólar Private Luxury Villa","2017-04-02","2017-11-21" , 481426, "Villa", "Romantic", 5, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(53, "Hólar Private Luxury Villa","2017-04-02","2017-11-21" , 481426, "Villa", "Party", 5, "Sudurland");
        SQLiteJDBC.insertIntoHotelRooms(54, "Party Hotel Danna og Gilla","2017-01-02","2017-12-29" , 999999, "suite", "Party", 5, "Sudurland");
        ...
        SQLiteJDBC.insertIntoHotelRooms(58, "Emmuhótel","2017-04-02","2017-11-21" , 200000, "suite", "Romantic",4, "Nordurland");
    }
